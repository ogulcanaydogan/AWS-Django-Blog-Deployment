...
DATABASES = {
    'default': {
        ...
        'NAME': 'database2', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'database-1.cje2sims28nz.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsfproject-ogulcan-blog' # please enter your s3 bucket name
